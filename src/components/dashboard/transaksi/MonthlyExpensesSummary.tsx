    ...
    <div className="rounded-2xl p-6">
      ...
      <div className="space-y-3 mb-6">
        {displayExpenses.map((expense) => (
          <div 
            key={expense.id}
            className="bg-[#50488A] rounded-3xl overflow-hidden transition-all duration-300 ease-in-out"
          >
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-[#7971BC] rounded-full flex items-center justify-center">
            ...
            >
              <div className="px-4 pb-4 pt-4 bg-[#7971BC]">
                <div className="space-y-4">
                  <h5 className="text-white text-lg font-medium">Berapa yang kamu keluarkan?</h5>
                  ...
                  <div>
                    <input
                      ...
                      placeholder="200.000"
                      className="w-full bg-transparent border-b-2 border-white text-white text-2xl font-light pb-2 focus:outline-none focus:border-[#00F5A0] placeholder-white/50"
                    />
                  </div>
                  ...
                  <div className="flex gap-2 pt-2">
                    <button
                      ...
                      className="flex-1 bg-white/10 text-white font-medium py-3 rounded-xl hover:bg-white/20 transition-colors text-sm"
                    >
                      Batal
                    </button>
                    <button
                      ...
                      className="flex-1 bg-[#00F5A0] text-black font-medium py-3 rounded-xl hover:bg-[#00E68F] transition-colors text-sm"
                    >
                      Simpan
                    </button>
                  </div>
      ...
      {/* Add Button */}
      <button className="w-full bg-[#00F5A0] text-black font-bold py-4 rounded-3xl border-b-2 border-white hover:bg-[#00E68F] transition-colors flex items-center justify-center gap-2">
