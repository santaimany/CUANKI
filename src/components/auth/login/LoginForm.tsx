...
const LoginForm = () => {
    ...
    return (
        // Responsive container that preserves current layout but scales typography/padding on small screens
        <div className="w-full max-w-md mx-auto px-4 sm:px-6 md:max-w-lg lg:max-w-xl">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#363256] mb-3 text-center">
                Welcome Back!
            </h1>
            <p className="text-[#363256] mb-8 sm:mb-10 text-center text-base sm:text-lg opacity-70">
            ...
            <div className="text-center mt-6 sm:mt-8">
                ...
                <a href="#" className="text-[#363256] font-semibold hover:underline text-sm sm:text-base">
                    Sign up
                </a>
            </div>
        </div>
