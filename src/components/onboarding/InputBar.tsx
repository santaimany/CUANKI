  ...
  return (
    <div className="w-full max-w-3xl flex items-center gap-2 sm:gap-3 md:gap-4">
      <input
        ...
        className="flex-1 bg-white/10 border border-white/20 rounded-full px-4 sm:px-5 md:px-6 py-2.5 sm:py-3 text-sm sm:text-base text-white placeholder-white/60 outline-none onboarding-input"
      />
      <button
